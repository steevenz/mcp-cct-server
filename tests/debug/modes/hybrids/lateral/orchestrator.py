...
class LateralEngine(BaseCognitiveEngine):
    ...
    def execute(self, session_id: str, input_payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        validated_input = self._validate_payload(input_payload, LateralPivotInput)

        # 3. Fetch Session using base class helper
        ...
        self._score_and_save(session_id, lateral_thought, history, model_id=session.model_id)
