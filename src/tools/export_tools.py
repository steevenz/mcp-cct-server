...
def register_export_tools(mcp: FastMCP, orchestrator: CognitiveOrchestrator, settings: Any | None = None) -> None:
    """Registers session export and analysis tools based on configured groups."""
    if settings is None:
        enabled = {"export"}
    else:
    ...
    logger.info("Export Tools registered successfully (filtered).")
